...
int chp_15_lesson()
{
  ...
  Shader lightingShader(
    "../shaders/chapter_15/lesson/lighting_maps.vert",
    "../shaders/chapter_15/lesson/lighting_maps.frag"
  );
  Shader lightCubeShader(
    "../shaders/chapter_15/lesson/cube.vert",
    "../shaders/chapter_15/lesson/cube.frag"
  );
  ...
  while (!glfwWindowShouldClose(window))
  {
    ...
    // light properties
    lightingShader.setVec3("light.ambient", 0.2f, 0.2f, 0.2f); // Original: 0.2
    lightingShader.setVec3("light.diffuse", diffuseVal, diffuseVal, diffuseVal);
